...
void setup() {
  ...
  preferences.begin("my-app-namespace", true);

  // Get wifi ssid and password from NVS
  wifiSSID = preferences.getString("wifiSSID", ""); // If no ssid found, return empty string
  wifiPassword = preferences.getString("wifiPassword", ""); // If no password found, return empty string
